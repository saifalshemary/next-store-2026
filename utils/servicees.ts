...
export const services:Service[]=[
    ...
    {name : 'bbq grill with a masterchef diploma' ,icon: FiWind, selected: false,},
    ...
    {name: 'air conditioning (breeze from the west)', icon:FiBox, selected:false},
    ...
    {name: 'cooking utensils (sticks and stones)', icon: FiHeadphones, selected:false},
